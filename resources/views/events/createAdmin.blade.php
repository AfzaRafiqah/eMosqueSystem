...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card bg-grey">
            ...
            <div class="body cuba">
                <form action="{{ route('events.store') }}" method="POST" onsubmit="return Compare()">
                    @csrf
                    ...
                    <div class="container">
                        <div class="row clearfix">
                            ...
                            <small>**Click "Limited Participant" to record participant**</small>
                            <div class="form-group">
                                <div class="demo-radio-button">
                    ...
                    <input type="hidden" id="numPart" name="numPart" value="0">
                    <input type="hidden" id="minAge" name="minAge" value="0">
                    <input type="hidden" id="maxAge" name="maxAge" value="0">
                    ...
                    <div class="row clearfix" id="dvpart" style="display: none">
                        ...
                        <div class="col-sm-2">
                            <label for="minAge">Minimum Age(Year)</label>
                            <div class="form-group">
                                <div class="form-line">
                        ...
                        <div class="col-sm-2">
                            <label for="maxAge">Maximum Age(Year)</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="number" id="maxAge" name="maxAge" class="form-control" value=0 required="required" />
                                </div>
                            </div>
                        </div>
                    </div>
