                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="project-actions text-left">
                                ...
                                @if($e->status == 'Pending' )
                                <a class="btn bg-indigo waves-effect" href="{{ route('events.edit',$e->id) }}">Update</a>
                                @endif
                                @if($e->status == 'Approve' || $e->status == 'Pending')
                                <a class="btn btn-danger" onclick="return confirm('Are you sure you want to cancel the event?')" href="{{ route('events.cancel',$e->id) }}">Cancel</a>
                                @endif
                            @csrf
                            </td>
                        </tr>
