        ...
        <div class="card profile-card">
            ...
            <div class="profile-body">
                <div class="image-area">
                    <img src="{{ asset('templateMosque/New/images/user.png') }}" alt="AdminBSB - Profile Image" />
                </div>
                        ...
                        <div role="tabpanel" class="tab-pane fade in active" id="profile_settings">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    <a class="btn btn-primary" href="{{ route('committees.edit',auth()->id()) }}">Update Profile</a>
                                </div>
                            </div>
                        </div>
                        <div role="tabpanel" class="tab-pane fade in" id="change_password_settings">
                            <form class="form-horizontal" method="POST" action="{{ route('change.password') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-line">
                                            <input type="password" class="form-control" id="password" name="current_password" placeholder="Old Password" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
