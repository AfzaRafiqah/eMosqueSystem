...
<head>
    <meta charset="utf-8" />
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('templateMosque/assets/img/mosqueIcon.jpg') }}">
    ...
    <script type="text/javascript">
        function CheckEvents(val) {
            ...
            if (val == 'Tahlil/Doa Selamat' || val == 'Akad Nikah') {
...
<body>
    <div class="wrapper">
        <div class="sidebar" data-image="{{ asset('templateMosque/assets/img/mosqueSidebar.jpg') }}" data-color="orange">
            <!--
            ...
            <div class="sidebar-wrapper">
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('committees.show',Auth::user()->id)  }}">
                            <i class="nc-icon nc-circle-09"></i>
                            <p>User Profile</p>
                        </a>
                    </li>
                    <li>
                        <a class="nav-link" href="{{ route('participates.index') }}">
...
<!--   Core JS Files   -->
<script src="{{ asset('mosqueTemplate/assets/js/core/jquery.3.2.1.min.js') }}" type="text/javascript"></script>
<script src="{{ asset('mosqueTemplate/assets/js/core/popper.min.js') }}" type="text/javascript"></script>
<script src="{{ asset('mosqueTemplate/assets/js/core/bootstrap.min.js ') }}" type="text/javascript"></script>
<!--  Plugin for Switches, full documentation here: http://www.jque.re/plugins/version3/bootstrap.switch/ -->
<script src="{{ asset('mosqueTemplate/assets/js/plugins/bootstrap-switch.js') }}"></script>
<!--  Google Maps Plugin    -->
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=YOUR_KEY_HERE"></script>
<!--  Chartist Plugin  -->
<script src="{{ asset('mosqueTemplate/assets/js/plugins/chartist.min.js') }}"></script>
<!--  Notifications Plugin    -->
<script src="{{ asset('mosqueTemplate/assets/js/plugins/bootstrap-notify.js') }}"></script>
<!-- Control Center for Light Bootstrap Dashboard: scripts for the example pages etc -->
<script src="{{ asset('mosqueTemplate/assets/js/light-bootstrap-dashboard.js?v=2.0.0 ') }}" type="text/javascript"></script>
<!-- Light Bootstrap Dashboard DEMO methods, don't include it in your project! -->
<script src="{{ asset('mosqueTemplate/assets/js/demo.js') }}"></script>
