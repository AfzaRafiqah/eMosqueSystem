...
<head>
    ...
    <!-- Sweetalert Css -->
    <link href="{{ asset('templateMosque/New/plugins/sweetalert/sweetalert.css') }}" rel="stylesheet" />
...
<body class="theme-blue">
    ...
    <section>
        <!-- Left Sidebar -->
        <aside id="leftsidebar" class="sidebar bg-blue">
            <!-- User Info -->
            <div class="user-info">
                <div class="image">
                    <img src="{{ asset('templateMosque/New//images/mosque1.gif ') }}" width="80" height="60" alt="User" />
                </div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="{{ route('myBookings.create') }}">Create Event</a>
                            </li>
                            <li>
                                <a href="{{ route('uEvents.index') }}">Available</a>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="{{ route('participates.myPartIndex') }}">Joined</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="{{ route('uCommittees.index') }}">
    ...
    <script src="{{ asset('templateMosque/New/plugins/sweetalert/sweetalert.min.js') }}"></script>
